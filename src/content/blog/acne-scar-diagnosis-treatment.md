...
Acne scars are permanent structural changes in the skin caused by inflammation from past acne lesions. Because the damage beneath each scar is structurally different, no single treatment addresses all scar types equally. Dermatology literature classifies atrophic acne scars into three main types: ice pick, rolling, and boxcar scars.

## What Are the Three Main Types of Acne Scars?

There are three distinct types of atrophic acne scars, each with a different underlying structure that determines which treatment approach is appropriate.
...
Boxcar scars are wider depressions with clearly defined edges and a crater-like appearance. Shallow boxcar scars often respond well to resurfacing treatments, while deeper boxcar scars may require combination approaches depending on scar depth and individual skin condition.
...
|---|---|
| Subcision | Releases fibrous bands beneath rolling scars |
| Fractional laser resurfacing | Stimulates collagen; improves surface texture |
| TCA CROSS | Targets deep ice pick scars specifically |
| Chemical peels | Addresses surface texture and post-inflammatory pigmentation |
| Dermal fillers | Provides volume correction in select atrophic scars |
| Pigment-control skincare | Manages post-inflammatory hyperpigmentation (PIH) |

This is why proper scar diagnosis must come before treatment selection.
...
A proper acne scar consultation evaluates the following before any treatment is recommended:

- Scar type (ice pick, rolling, boxcar, or mixed presentation)
- Scar depth
...
*References: Connolly D et al., Journal of Clinical and Aesthetic Dermatology, 2017; Fabbrocini G et al., Dermatology Research and Practice, 2010; and additional peer-reviewed sources cited in the original clinical review.*