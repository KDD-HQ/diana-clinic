...
|---|---|---|---|---|
| **Melasma** | Hormones + UV + visible light | Symmetrical brown or grey-brown patches | Cheeks, forehead, upper lip, nose | Chronic, relapse-prone |
...
| **Freckles** | Genetics + UV | Small, light brown macules | Nose, cheeks, sun-exposed areas | Darken in sun, may fade in winter |
...
A proper assessment typically includes several elements beyond visual appearance. Pattern and symmetry help distinguish melasma (bilateral, symmetric) from PIH (follows the distribution of past inflammation). Clinical history covers hormonal context, past acne or eczema, previous treatments, and family history. A Wood lamp examination uses UV light to help estimate whether pigment sits in the epidermis or dermis. Dermoscopic examination allows closer evaluation of pigment patterns.
...
A doctor assesses pattern (melasma is typically bilateral and symmetric; PIH usually follows the distribution of past inflammation), clinical history (hormonal triggers point to melasma; past acne or eczema points to PIH), and may use a Wood lamp or dermoscope to help estimate pigment depth.
...
A Wood lamp is a UV light tool that helps assess whether pigmentation sits in the epidermis (often enhances under Wood light) or the dermis (usually does not enhance). This information guides treatment selection and helps set realistic expectations.
...
### Should I treat my pigmentation if it doesn't bother me?
