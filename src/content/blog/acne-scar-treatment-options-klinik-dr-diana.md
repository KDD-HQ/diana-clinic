...
lang: "en"
tags: ["acne scars", "acne scar treatment", "subcision", "microneedling", "CO2 laser", "TCA CROSS", "Rejuran S", "biostimulator", "Bangi", "Senawang", "Seremban"]
heroImage: "/images/blog/acne-scar-treatment-options-klinik-dr-diana.jpg"
draft: false
---
## Executive Summary

Acne scar treatment is rarely about a single procedure. At Klinik Dr Diana, treatment plans may combine subcision, medical microneedling, fractional CO2 laser, TCA CROSS, Rejuran S, biostimulators, fillers, and chemical peels depending on the scar type, skin type, and healing risk.
...
- Rejuran S, CaHA, PDLLA, and other regenerative options can support dermal repair.
- Malaysian skin types need careful planning because PIH risk must be managed.
- Klinik Dr Diana assesses scar type before recommending a treatment plan.
...
* Rolling scars with visible tethering  
* Selected tethered boxcar scars  
* Rolling scars that have responded poorly to resurfacing alone

Bruising and swelling are common and may last several days to around two weeks. Subcision is technique-dependent and should only be performed by a trained clinician who understands scar anatomy and how to assess tethering depth. At KDD, subcision is often combined with a biostimulator or skin booster in the same plan, so that the released space is supported by new collagen as the skin heals.
...
#### How does fractional CO2 laser work for acne scars?
...
#### What role do skin boosters like Rejuran S play in acne scar treatment?

Skin boosters are injectable regenerative treatments delivered into the dermis to improve skin quality from within. Rejuran S is the variant in the Rejuran range specifically formulated for atrophic acne scars.

Rejuran S contains polynucleotides (PN) derived from highly purified salmon DNA. The polynucleotides are biocompatible with human skin and work through several mechanisms:

* Stimulating fibroblast proliferation, which drives new collagen synthesis  
* Modulating inflammation in chronically scarred tissue  
* Supporting tissue repair and microvascular regeneration in the dermis

Unlike a filler, Rejuran S does not lift the scar by adding volume. It rebuilds dermal quality so the skin around and beneath the scar becomes thicker, healthier, and more resilient over a course of sessions. It is best understood as a foundation treatment that pairs well with subcision, microneedling, or TCA CROSS in a combination plan. The Rejuran range is one of the most clinically studied polynucleotide platforms globally, and the scar variant has documented case-series evidence for improvement in scar texture.

Rejuran S is typically delivered across 3 to 4 sessions, spaced about a month apart, with gradual improvement evolving over 8 to 12 weeks. It is well-tolerated in Fitzpatrick IV to VI skin because there is no thermal component.
...
#### When are dermal fillers used for acne scars?
...
#### Where do chemical peels fit in?

Chemical peels are most useful for post-inflammatory hyperpigmentation, uneven skin tone, mild superficial texture, and supporting acne control in selected patients. Superficial peels do not release fibrous tethering and usually do not reach the depth needed to correct deeper atrophic scars.

For structural acne scars, peels are best understood as supportive treatments rather than the main correction method. They are often layered into a multi-month plan alongside subcision, microneedling, or biostimulators to address pigmentation while the deeper work proceeds.

---

#### Which acne scar treatment is right for which scar type?

The table below summarises how KDD typically matches modality to scar type. Most patients have more than one scar type on the same face, which is why combination planning matters.

| Scar Type | Primary Treatments | Supporting Treatments |
| ----- | ----- | ----- |
| Rolling (tethered) | Subcision, aggressive microneedling | Rejuran S, biostimulators (CaHA or PDLLA) |
| Boxcar (shallow) | Aggressive microneedling, fractional CO2 (selected) | Rejuran S, chemical peels |
| Boxcar (deep) | TCA CROSS (narrow), subcision (tethered) | Aggressive microneedling, Rejuran S |
| Ice pick | TCA CROSS, punch excision | Rejuran S for surrounding texture |
| Pigmentation only (PIH) | Chemical peels, topical regimen | Sun protection, oral adjuncts |

This is a general framework, not a prescription. The actual plan depends on scar density, skin type, prior treatments, healing tendency, and the patient's timeline.

---

#### Frequently asked questions about acne scar treatment

**How many sessions will I need to see a difference?** Most atrophic acne scar plans run across 4 to 8 sessions over 6 to 12 months, depending on scar severity and the modalities combined. Improvement is gradual and tends to become clearly visible from the 3rd to 4th session onward.

**Is treatment painful?** Topical anaesthetic is applied before most procedures. Subcision and TCA CROSS involve some discomfort even with anaesthetic. Skin boosters and biostimulators are generally well-tolerated.

**Will my acne scars ever fully disappear?** Realistic improvement for atrophic acne scars is in the range of 50 to 80 percent over a complete plan, depending on scar type and individual healing. Full disappearance is not a promise any LCP-certified clinic should make.

**Is it safe for Malaysian (Fitzpatrick IV to VI) skin?** Yes, when treatment is planned conservatively, pigment risk is managed before and after each session, and the right modalities are chosen. This is one reason KDD favours mechanical aggressive microneedling, polynucleotides, and biostimulators over more aggressive ablative resurfacing in many patients.

**Can I combine treatments in the same visit?** Often, yes. Subcision plus a biostimulator or skin booster in the same session is a common combination. The doctor will plan combinations based on healing capacity and downtime tolerance.

**What is the difference between a skin booster and a biostimulator?** A skin booster like Rejuran S delivers polynucleotides that repair and regenerate dermal tissue quality. A biostimulator introduces a scaffold material (such as CaHA or PDLLA) that triggers the body to build new collagen structures. Both improve the dermis, but through different biological pathways. They can be used together in the same scar plan.
...
* Bandar Baru Bangi: [WhatsApp Us](https://api.whatsapp.com/send?phone=60183902910&text=%5BWEB%5D%20Hi%20Klinik%20Dr%20Diana.%0ASaya%20ingin%20bertanya%20mengenai%20%2F%20I%20want%20to%20ask%20regarding%3A)
* Senawang: [WhatsApp Us](https://api.whatsapp.com/send?phone=60183902910&text=%5BWEB%5D%20Hi%20Klinik%20Dr%20Diana.%0ASaya%20ingin%20bertanya%20mengenai%20%2F%20I%20want%20to%20ask%20regarding%3A)
